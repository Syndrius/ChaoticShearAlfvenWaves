...
isl32b = init_island(m0=3, n0=-2, w=0.1, r0=0.5, qp=2.0)
#start with no islands
prob = init_problem(geo=geo, q=MID.Equilibrium.island_equiv_q, met=:cylinder, isl=isl32b)
#%%
...
save_object("/Users/matt/phd/MID/data/surfaces/island_32b.jld2", curr_surfs)
