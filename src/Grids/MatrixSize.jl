...
"""
function init_local_matrix(grids::ContGridsT)
...
Computes the size of the local I, W matrices needed at each grid point.
"""
function init_local_matrix(grids::FSSGridsT)
...
Computes the size of the local I, W matrices needed at each grid point.
"""
function init_local_matrix(grids::FFSGridsT)
...
Computes the size of the local I, W matrices needed at each grid point.
"""
function init_local_matrix(grids::FFFGridsT)
...
4's are for number of Hermite elements when using FEM, 9 is for total first and second derivatives.
"""
function init_trial_function(grids::FFFGridsT)
...
4's are for number of Hermite elements when using FEM, 9 is for total first and second derivatives.
"""
function init_trial_function(grids::FFSGridsT)
