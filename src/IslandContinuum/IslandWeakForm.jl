...
function island_W_and_I!(W::Array{ComplexF64, 2}, I::Array{ComplexF64, 2}, χ::Float64, θ̄grid::LinRange{Float64}, ζgrid::LinRange{Float64}, met::MetT, B::BFieldT, isl::ContIslandT, geo::GeoParamsT, sign::Int64)
