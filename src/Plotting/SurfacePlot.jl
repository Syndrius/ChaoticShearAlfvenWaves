"""
    surface_plot(ϕ, grids::FFSGridsT, ind, ζ=1; savefile=nothing)
...
"""
    surface_plot(ϕ, grids::FSSGridsT, ind, ζ=1; savefile=nothing)
...
"""
    surface_plot(ϕ, grids::FFFGridsT, ind, ζ=1; savefile=nothing)
