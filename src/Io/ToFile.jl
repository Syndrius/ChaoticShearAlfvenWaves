...
"""
function inputs_to_file(; prob, grids, solver, dir::String)
...
"""
function evals_to_file(evals, dir::String)
...
"""
function efuncs_to_file(ϕ::Array{ComplexF64}, ϕft::Array{ComplexF64}, dir::String)
    nevals = size(ϕft)[1]
