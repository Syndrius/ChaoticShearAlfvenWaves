...
function flux_cyl_qfm_q(ψ::Float64)
    #not doinge quivalent, just doing the same thing with flux to see if is better
    #so ignore this!
    return 1.0 + sqrt(2*ψ), (2*ψ)^(-1/2)
end
#%%
k1 = 0.00055
#k2 = 0.0003
...
poincare_plot(prob, Nlaps, Ntraj, ψlist, ylimits=(0.5, 0.7))
#%%
