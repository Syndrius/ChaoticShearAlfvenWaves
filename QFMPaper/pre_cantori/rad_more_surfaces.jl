...
k_onset = 0.0006 #ideally we could get this theoretically!

k_mid = 0.0009

k_max = 0.0012 #above this the qfm surfaces inside the chaotic region get cooked, this may still be too much though!

k = k_max

geo = init_geo(R0=4.0)
isl1 = init_island(m0=3, n0=-2, A=k/3)
isl2 = init_island(m0=5, n0=-3, A=k/5)
...
#%%
save_object("/Users/matt/phd/MID/data/surfaces/rad_qfm_max_surfs.jld2", curr_surfs)
